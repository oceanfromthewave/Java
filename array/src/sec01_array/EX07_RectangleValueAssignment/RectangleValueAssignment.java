...
public class RectangleValueAssignment {
	public static void main(String[] args) {
		...
		System.out.println(array2[1][0]+" "+array2[1][2]+" "+array2[1][2]+" " );
		
		System.out.println();
		
		int[][] array3 = new int[][] {{1,2,3},{4,5,6}};
		System.out.println(array3[0][0]+" "+array3[00][1]+" "+array3[0][2]+" ");
		...
		System.out.println(array4[0][0]+" "+array4[00][1]+" "+array4[0][2]+" ");
		...
		System.out.println(array5[0][0]+" "+array5[00][1]+" "+array5[0][2]+" ");
